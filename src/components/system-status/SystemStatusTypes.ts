...
export type INodeJsNetworkInterInfoIPv4 = INodeJsNetworkInterfaceBase  &  {
family: 'IPv4';
};

export type INodeJsNetworkInterInfoIPv6 = INodeJsNetworkInterfaceBase & {
  family: 'IPv6';
  scopeid: number;
};

export type INodeJsNetworkInterfaceInfo = | INodeJsNetworkInterInfoIPv4 | INodeJsNetworkInterInfoIPv6;
